  ...
  return (
    <section
      ...
      style={{
        ...
        backgroundImage: 'radial-gradient(at 20% 50%, rgba(249, 115, 22, 0.05) 0px, transparent 50%)',
      }}
    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => {
              ...
              <motion.div
                ...
                className={`glass-glow rounded-xl p-8 border transition-all duration-300 group relative overflow-hidden ${
                  isOrange 
